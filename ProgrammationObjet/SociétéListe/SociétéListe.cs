...
namespace SociétéListe
{
    class GérerSociétéListe
    {
        public static void Main(string[] args)
        {
            ...
            /*société.InsérerDebut(ref tira_misu);
            société.InsérerDebut(ref tarte_chocolat);
            société.InsérerDebut(ref snicker_doodle);
            société.InsérerDebut(ref cane_le_bordelais);
            société.InsérerDebut(ref crême_brulée);
            société.InsérerDebut(ref finn_ancier);
            société.InsérerDebut(ref macaron_chocolat);
            société.InsérerDebut(ref tarte_auxpommes);
            société.Lister();*/
